 ...
 * @author alecosta
 */
public class Exercicio16POO {

    public static void main(String[] args) {
        /*Construa uma classe para representar um carro. 
        ...
        Deve ser possível:
          ...
          Desloque o primeiro em 200 km e 
           o segundo em 400 km. 
          ...
          primeiro.abastecer(20);
          segundo.abastecer(30);
          
          primeiro.Mover(200);
          segundo.Mover(400);
          
          primeiro.retornaSituacao();
          segundo.retornaSituacao();
